...
public class NamedParameterPreparedStatement extends DelegatingPreparedStatement {
	private final LinkedHashMap<String, List<Integer>> orderedParameters;
	...
	/**
	 * Parse the query string containing named parameters and result a parse result,
	 * which holds the parsed sql (named parameters replaced by standard '?'
	 * parameters and an ordered list of the named parameters.
	 * 
	 * SQL parsing code borrowed from Adam Crume. Thanks Adam. See <a href=
	 * "http://www.javaworld.com/article/2077706/core-java/named-parameters-for-preparedstatement.html?page=2">http://www.javaworld.com/article/2077706/core-java/named-parameters-for-preparedstatement.html?page=2</a>
	 * 
	...
	public static NamedParameterPreparedStatement createNamedParameterPreparedStatement(Connection conn, String sql)
		...
		return new NamedParameterPreparedStatement(conn.prepareStatement(parseResult.getSql()),
	...
	public static NamedParameterPreparedStatement createNamedParameterPreparedStatement(Connection conn, String sql,
		...
		return new NamedParameterPreparedStatement(
				conn.prepareStatement(parseResult.getSql(), resultSetType, resultSetConcurrency),
				parseResult.getOrderedParameters());
	}
	 ...
	 * @param orderedParameters Ordered list of named parameters produced during
	 *                          parsing
	 */
	...
	public boolean hasNamedParameter(String parameterName) {
		return orderedParameters.containsKey(parameterName);
	}

	private Collection<Integer> getParameterIndexes(String parameter) {
		Collection<Integer> indexes = this.orderedParameters.get(parameter);
		if (indexes.isEmpty()) {
